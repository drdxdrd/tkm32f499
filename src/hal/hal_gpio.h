...
typedef enum
{ 
GPIO_Mode_AIN = 0x0,  //模锟斤拷锟斤拷锟斤拷
GPIO_Mode_IN_FLOATING = 0x04, //锟斤拷锟斤拷锟斤拷锟斤拷
GPIO_Mode_IPD = 0x28,  //锟斤拷锟斤拷锟斤拷锟斤拷
GPIO_Mode_IPU = 0x48,  //锟斤拷锟斤拷锟斤拷锟斤拷
GPIO_Mode_Out_OD = 0x14,//通锟矫匡拷漏锟斤拷锟斤拷
GPIO_Mode_Out_PP = 0x10,//通锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
GPIO_Mode_AF_OD = 0x1C, // 锟斤拷锟矫匡拷漏锟斤拷锟斤拷
GPIO_Mode_AF_PP = 0x18  //锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷
}GPIOMode_TypeDef;
