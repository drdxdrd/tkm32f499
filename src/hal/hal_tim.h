...
TIM clock. This parameter can be a number between 0x0000 and 0xFFFF */
...
This parameter can be a value of @ref TIM_Clock_Division_CKD */
 ...
 Each time the RCR downcounter reaches zero, an update event is generated and
 counting restarts from the RCR value (N). This means in PWM mode that (N+1)
 corresponds to:
